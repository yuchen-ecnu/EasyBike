...
class ProxyProvider:
    ...
    def get_list(self):
        ...
        r = requests.get("https://jsonblob.com/api/jsonBlob/31bf2dc8-00e6-11e7-a0ba-e39b7fdbe78b",verify=False, timeout=10)
        #r = requests.get("http://www.89ip.cn/api/?&tqsl=1000&sxa=&sxb=全国&tta=&ports=&ktip=&cf=1", timeout=10)
